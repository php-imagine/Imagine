...
abstract class AbstractIsImageEqualTest extends ImagineTestCase
{
    public function testThrowsExceptionWithInvalidArguments()
    {
        ...
        $this->assertRegularExpression('/^Argument #1 .* must be an? /', $error->getMessage());
        ...
        $this->assertRegularExpression('/^Argument #2 .* must be an? /', $error->getMessage());
        ...
        $this->assertRegularExpression('/^Argument #4 .* must be an? /', $error->getMessage());
        ...
        $this->assertRegularExpression('/^File .* does not exist.$/', $error->getMessage());
    }
